...
# Ask for user inputs
def get_user_inputs():
    collection_delay = int(input("Enter collection delay (in ms): "))
    min_sound_delay = int(input("Enter minimum sound delay (in ms): "))
    max_sound_delay = int(input("Enter maximum sound delay (in ms): "))
    control_prob = int(input("Enter control probability (in percentage): "))
    target_prob = int(input("Enter target probability (in percentage): "))
    
    
    return {
        "min_sound_delay": min_sound_delay,
        "max_sound_delay": max_sound_delay,
...
def build_sound_prob_arr():
    SOUND_PROB_ARR = [0] * PARAMS["control_prob"]
